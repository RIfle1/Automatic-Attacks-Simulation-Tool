...
from attacks.credential_stuffing.global_variables import headers_global, USERNAME_KEY, PASSWORD_KEY, LOGIN_SUCCESS_KEY
from attacks.credential_stuffing.main import set_credentials, credential_stuffing
